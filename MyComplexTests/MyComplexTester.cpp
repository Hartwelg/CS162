...
TEST_CASE( "Complex/0-arg constructor" ) {
    MyComplex c;
...
TEST_CASE( "Complex/1-arg constructor" ) {
    MyComplex c(4);
...
TEST_CASE( "Complex/2-arg constructor" ) {
    MyComplex c(4.3, -2);
...
TEST_CASE( "Complex/Addition and Subtraction" ) {
    MyComplex c1(5, 1);
    MyComplex c2(3, 2);
    MyComplex c3 = c1 + c2;
...
TEST_CASE( "Complex/Addition Assignment" ) {
    MyComplex c1(5, 1);
    MyComplex c2(3, 2);
    c1 += c2;
...
TEST_CASE( "Complex/Subtraction Assignment" ) {
    MyComplex c1(5, 1);
    MyComplex c2(3, 2);
    c1 -= c2;
...
TEST_CASE( "Complex/Multiplcation Assignment" ) {
    MyComplex c1(2, 4);
    MyComplex c2(6, -2);
    c1 *= c2;
...
TEST_CASE( "Complex/Division Assignment" ) {
    MyComplex c1(2, 4);
    MyComplex c2(6, -2);
    c1 /= c2;
...
TEST_CASE( "Complex/PreIncrement" ) {
    MyComplex c2(5);
...
TEST_CASE( "Complex/PostIncrement" ) {
    MyComplex c1(5);
...
TEST_CASE( "Complex/PreDecrement" ) {
    MyComplex c2(5);
...
TEST_CASE( "Complex/PostDecrement" ) {
    MyComplex c1(5);
    REQUIRE( (c1--).getRealPart() == Approx(5) );
...
TEST_CASE( "Complex/Stream Insertion" ) {
    MyComplex c(-4, -2);
    MyComplex c2(4, 2);
...
TEST_CASE( "Complex/Stream Extraction" ) {
    MyComplex c;
    MyComplex c2;
    char extra;
